...
<br><h5><b>Adicionar transferência entre contas</b></h5><br>
...
<form action="TransferenciaServlet" method="post">
                <div class="container" id="area">
                	...
                	<div class="row">
                	 <div class="col">Conta de origem: *</div>
                	 <div class="col"> <input type="text" name="contaOrigem" id="contaOrigem" /></div>
                	 </div>
                	 
                	 <div class="row">
                	 <div class="col">Conta de destino: *</div>
                	  <div class="col"><input type="text" name="contaDestino" id="contaDestino" /></div>
                	 </div>
                	 
                	 <div class="row">
                	 <div class="col"> Descrição:   </div>
                	 <div class="col"> <input type="text" name="descricao" id="descricao" /></div>
                	 </div>
